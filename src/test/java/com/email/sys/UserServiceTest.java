...
class UserServiceTest {
    ...
    void testUserFoundForEmail(){
        ...
        when(typedQuery.getSingleResultOrNull()).thenReturn(mockUser);
    ...
    void testGetFilteredInbox(){
        ...
        ObservableList<Email> filteredInbox = userService.getFilteredInbox(
                user.getId(), filterText
        );
    ...
    void testLogInWrongPassword(){
        String email = "email@email.com";
        String incorrectPassword = "192837465";
        User u = new User();
        u.setEmail(email);
